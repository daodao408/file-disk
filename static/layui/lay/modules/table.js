...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function(e) {
                ...
                t.ajax({
                    ...
                    error: function(e, t) {
                        ...
                        if (e.status == '401') {
                            ...
                            e.status == '400' &&
                            e.responseJSON.message.indexOf('删除,请刷新') > -1
                        ) {
                            i.layMain.html(
                                '<div class="' +
                                h +
                            ...
                            e.status == '400' &&
                            e.responseJSON.message.indexOf(
                                '已取消,无法操作该文件,请刷新界面'
                            ) > -1
                        ) {
                            i.layMain.html(
    ...
    (j.prototype.events = function() {
                                    ...
                                    layui.each(o.cols, function(e, t) {
                                        layui.each(t, function(t, i) {
                                            if (e + '-' + t === n) {
                                                ...
                                                (i.hide = !l),
                                                a.elem
                                                    .find('*[data-key="' + o.index + '-' + n + '"]')[l ? 'removeClass' : 'addClass'](y),
        ...
        a.layBody
            ...
            //     if (Math.round(elemCell.prop('scrollWidth')) > 0) {
            ...
            .on('click', 'td', function() {
                ...
                if (!e.data('off') && i) {
                    ...
                    return (
                        (l[0].value = e.data('content') || a.text()),
